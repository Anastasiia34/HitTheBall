...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var numberOfBallsLeft = 5 {
        didSet {
            ballsLeftLabel.text = "\(numberOfBallsLeft) balls left"
        }
    }
    ...
    override func didMove(to view: SKView) {
        ...
        ballsLeftLabel.text = "5 balls left"
        ...
        if let touch = touches.first{
            ...
            if objects.contains(editLabel) {
                ...
                if editingMode {
                    ...
                    box.name = "box"
                    addChild(box)
                } else if numberOfBallsLeft != 0 {
                    let ballColors = ["Blue", "Cyan", "Green", "Grey", "Purple", "Red", "Yellow"]
                    let randomBallName = "ball" + ballColors.randomElement()!
